...
bool TCPClient::connect(char *ipAddr, int port)
{
    ...
    if (sockfd < 0){
	__android_log_write(ANDROID_LOG_ERROR, "VNC_TCPClient", "ERROR opening socket");
    ...
    if (server == NULL) {
        ...
        __android_log_write(ANDROID_LOG_ERROR, "VNC_TCPClient", "ERROR, no such host");
        exit(0);
    }
	...
	__android_log_write(ANDROID_LOG_ERROR, "VNC_TCPClient", "ERROR connecting");
